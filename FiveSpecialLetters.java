...
public class FiveSpecialLetters {
                ...
                for (char third = 'a'; third <= 'e'; third++) {
                    for (char fourth = 'a'; fourth <= 'e'; fourth++) {
                        for (char fifth = 'a'; fifth <= 'e'; fifth++) {
                            ...
                            long weight = calcWholeWordWeight(wholeWord);
    ...
    public static long calcWholeWordWeight(String word) {
        long weight = 0;
        int index = 1;
        ...
        for (int i = 0; i < word.length(); i++) {
            ...
            if (!visited[currentLetter]) {
                ...
                weight += index * calcEachLetterWeight((currentLetter));
                index++;
            }
        }
        return weight;
    ...
    public static int calcEachLetterWeight(Character letter) {
